                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <h1
                                        ...
                                        Welcome to {{ $user->first_name }} {{ $user->last_name }}!</h1>
                                    <span
                                    ...
                                    {{-- <a href="{{ config('app.url') }}" --}}
                                            {{--    style="background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Get Started</a> --}}
                                </td>
                            </tr>
                            <tr>
                                <td style="height:40px;">&nbsp;</td>
