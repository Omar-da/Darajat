...
<head>
    ...
    <meta name="description" content="Payment Failure Notification">
    <style type="text/css">
        a:hover {
                            ...
                            <tr>
                                <td class="responsive-padding" style="padding:0 35px;">
                                    ...
                                    <p style="color:#455056; font-size:15px; line-height:24px; margin:0 0 20px 0;">
                                        We were unable to process your payment for the course "{{$order->course->title}}". Please try again or contact support if the problem persists.
                                    </p>
